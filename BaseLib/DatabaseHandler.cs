...
namespace BaseLib
{
    public class DataBaseHandler
    {
       ...
       // public static string CONstr = "Data Source=" + Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "\\TwtDominator\\DB_TwtDominator.db" + ";Version=3;";
        public static string CONstr = "Data Source=" + "C:\\LinkedInDominator\\Data\\DB_LinkedInDominator.db";
