...
namespace BaseLib
{
    public static class SearchCriteria
    {
        ...
        public static string within = "50";
        ...
        public static int scraperMinDelay = 10;
        public static int scraperMaxDelay = 20;

        public static int JobscraperMinDelay = 10;
        public static int JobscraperMaxDelay = 20;
